...
def comment_extract(num, soup):
    ...
    return num, datetime, text_jp, text_kr, anchor, plus, minus,

####아래는 다른것들과 거의 비슷#####
import json
def comment_jsonify(num, datetime, text_jp, text_kr, anchor, plus, minus): #위에선 comment_num을 걍 num이라고해버림...
    return {"comment_num": num, "comment_datetime": datetime, "comment_authorId": "익명", "comment_anchor": anchor, "comment_text": text_jp, "comment_text_kr": text_kr, "plus": plus, "minus": minus}
